...
<div class="py-4 px-4 sm:px-6 lg:px-8 flex-1 flex flex-col">
  <main class="max-w-7xl mx-auto w-full px-6 py-10 md:px-12 bg-white/70 backdrop-blur-sm rounded-[2.5rem] shadow-2xl border border-white/20 min-h-[calc(100vh-8rem)] flex flex-col">
    <div class="text-center mb-12">
      <h1 class="text-4xl lg:text-5xl font-bold text-[#C53030] tracking-tight">Affiliates</h1>
    </div>

    <section class="mb-16">
      <div class="flex items-center justify-center gap-3 mb-10">
        <h2 class="text-2xl md:text-3xl font-bold text-gray-900 border-b-4 border-[#C53030] pb-2 px-4 inline-block">Industry Partners</h2>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <a href="https://www.monolythai.com/" target="_blank" class="group flex flex-col bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-xl hover:border-[#C53030] transition-all duration-300 transform hover:-translate-y-1 text-center h-full">
          ...
          <div class="mt-3 text-sm font-bold text-[#C53030] flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
            Visit Website <i class="bx bx-right-arrow-alt ml-1 text-lg"></i>
          </div>
        </a>
    ...
    <section class="mb-16 flex-1">
      <div class="flex items-center justify-center gap-3 mb-10">
        <h2 class="text-2xl md:text-3xl font-bold text-gray-900 border-b-4 border-[#C53030] pb-2 px-4 inline-block">Research & Academic Affiliates</h2>
      </div>
    ...
    <section class="bg-red-50 border border-red-100 rounded-2xl p-8 md:p-10 text-center">
      <h3 class="text-2xl md:text-3xl font-bold text-[#C53030] mb-4">Partnership Opportunities</h3>
      <p class="text-gray-800 text-base md:text-lg font-medium mb-8 max-w-3xl mx-auto leading-relaxed">
      ...
      <p class="text-sm font-bold text-gray-500 mb-4 uppercase tracking-wider">Contact Us For Inquiries</p>

      <div class="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8">
        <a href="mailto:usd.airesearch.lab@gmail.com" class="inline-flex items-center text-gray-800 hover:text-[#C53030] font-bold transition-colors">
          <i class="bx bx-envelope text-xl mr-2 text-[#C53030]"></i>
          usd.airesearch.lab@gmail.com
        </a>
        <span class="hidden md:block text-gray-300">|</span>
        <a href="mailto:kc.santosh@usd.edu" class="inline-flex items-center text-gray-800 hover:text-[#C53030] font-bold transition-colors">
          <i class="bx bx-envelope text-xl mr-2 text-[#C53030]"></i>
          kc.santosh@usd.edu
        </a>
      </div>
